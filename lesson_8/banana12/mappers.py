import sqlite3
from lesson_8.banana12.models import Student, Category, Course
...
class CourseMapper:
    ...
    def all(self):
        ...
        for item in self.cursor.fetchall():
            ...
            course = Course(name, category.course)
            course.id = id
    ...
    def insert(self, obj):
        ...
        self.cursor.execute(statement, (obj.name, obj.category.course,))
        try:
            self.connection.commit()
        except Exception as e:
            raise DbCommitException(e.args)
